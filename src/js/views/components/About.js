  ...
  _generateMarkup() {
    const markup = /*html*/`
      <div class="${this._elementName}">
        <div class="relative flex items-center lg:h-section bg-tertiary pt-24 pb-32 xs:py-32 lg:py-24">
          <div class="relative mx-auto max-w-xl px-4 xxs:px-8 text-center md:max-w-2xl lg:max-w-6xl xl:max-w-7xl lg:px-8 ">
            <div class="">
              ...
              <p class="mt-2 text-2xl xxs:text-3xl font-semibold tracking-tight text-slate-700">Lorem ipsum dolor sit, amet consectetur</p>

              <p class="mx-auto mt-5 max-w-prose px-2 text-xl text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Omnis adipisci quo minus, dicta eveniet itaque unde vel eius? Eum, quae.</p>
            </div>
            <div class="mt-20">
