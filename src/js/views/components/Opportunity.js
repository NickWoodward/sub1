...
class Opportunity extends View {
  ...
  _generateMarkup() {
    const markup = /*html*/`
      <div class="${this._elementName} menu-section bg-slate-200  scroll-mt-[180px]" id="${this._elementName}">
        ...
        <div class=" flex items-end  min-h-min xs:pt-24 lg:pt-16 xl:pt-22">
          <div class="relative pt-20 pb-24 w-full">
            ...
            <div class="opportunity-bg-2 absolute top-0 left-0 pt-24 pb-28 sm:pt-0 sm:pb-0 w-full h-full bg-primary"></div>
            <div class="flex max-w-xl h-full mx-auto  px-4 xs:pt-0 xs:pb-12 sm:pb-24 xxs:px-8 md:max-w-2xl m lg:relative lg:max-w-6xl xl:max-w-[1440px] xl:px-0 lg:z-10 lg:pb-0">
              <div class="  xs:-mt-32 lg:mt-0 relative h-full w-full xxs:max-w-xl xs:mx-auto md:max-w-2xl lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-8 ">
                ...
                <!-- Content Wrapper -->
                <div class="h-full flex flex-col justify-start space-y-8 xs:space-y-6 sm:space-y-10  xs:absolute xs:left-0 xs:top-0 xs:h-full xs:pt-10 xs:pb-14 xs:px-10 lg:relative lg:justify-start lg:mt-0 lg:left-auto lg:top-auto lg:col-span-2 lg:pl-12">
                  <p class="opportunity-headline mt-0 text-xl px-2 xs:px-0 xs:text-2xl md:text-3xl font-semibold tracking-tight text-primaryDark xs:text-primary sm:font-medium lg:text-primaryDark lg:mt-8 lg:pl-10 xl:mt-16">${this.title}</p>

                  <div class="opportunity-content grow flex mx-auto max-w-md  px-4 xs:px-0 xs:max-w-2xl lg:max-w-5xl lg:mt-0 lg:px-0 lg:pt-8 lg:pb-6">
                    <blockquote>
                      <div class="relative">
                        ...
                        <p class="opportunity-description flex flex-col mt-2 text-lg xs:text-xl text-white lg:pl-10">
                          ${this.content}
